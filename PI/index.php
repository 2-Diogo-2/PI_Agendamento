    ...
    <div class="carousel">
      <?php foreach ($bandas as $banda): ?>
        <div class="carousel-item">
          <img src="http://localhost/pi/php/uploads/<?= htmlspecialchars($banda['foto_url']) ?>" alt="<?= htmlspecialchars($banda['nome_banda']) ?>"> <!-- Use foto_url -->
...
<section class="carousel-section">
    ...
    <div class="carousel">
      <?php foreach ($espacos as $espaco): ?>
        <div class="carousel-item">
          <img src="http://localhost/pi/php/uploads/<?= htmlspecialchars($espaco['foto_url']) ?>" alt="<?= htmlspecialchars($espaco['nome_espaco']) ?>"> <!-- Use foto_url -->
